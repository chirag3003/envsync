...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento row-span-1 flex flex-col justify-between space-y-4 border border-border bg-[hsl(var(--surface-1))] p-4 transition-colors duration-200 hover:border-primary/50",
        className
      )}
    >
      {header}
